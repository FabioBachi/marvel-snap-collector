...
const buttonVariants = cva(
  "gap-2 inline-flex items-center justify-center rounded-full text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        default:
        ...
        destructive:
          "bg-red-500 text-slate-50 hover:bg-red-500/90 dark:bg-red-500 dark:text-slate-50 dark:hover:bg-red-500/90",
        outline:
        ...
        secondary:
          "bg-slate-100 text-slate-500 hover:bg-slate-100/80 dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-800/80",
        ghost:
